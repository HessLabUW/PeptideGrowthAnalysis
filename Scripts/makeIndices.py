...
parser.add_argument('-s','--strim', help='Trim bases from start; default is 30',
                        default=30, type=int)

parser.add_argument('-e', '--etrim', help='Trim bases from end; default is 30',
                        default=30, type=int)
...
fasta_location = os.path.join('/project8/HessLabCHGPM/PublicGitHubRepos/PeptideGrowthAnalysis/PeptideGrowthAnalysis/Indices', 'temp_fasta.fna')
...
try:
    subprocess.check_call(args.bowtie + ' ' + fasta_location + ' ' + 
                                            os.path.join('/project8/HessLabCHGPM/PublicGitHubRepos/PeptideGrowthAnalysis/PeptideGrowthAnalysis/Indices', args.full_name),
                                                                    shell=True)
except:
    sys.exit()
...
index_name = os.path.join('/project8/HessLabCHGPM/PublicGitHubRepos/PeptideGrowthAnalysis/PeptideGrowthAnalysis/Indices', args.full_name)
